<section class="conteudo">
    ...
    <div class="containerAdocao">
        ...
        <div class="animal-item">
            <img src="../img/gato2.jpeg" alt="Animal 2">
            <h3>Mia</h3>
            <p><strong>Espécie:</strong> Gato</p>
        ...
        <div class="animal-item">
            <img src="../img/gato.jpg" alt="Animal 3">
            <h3>Tapioca</h3>
            <p><strong>Espécie:</strong> Gato</p>
        ...
        <div class="animal-item">
            <img src="../img/dog3.jpeg" alt="Animal 4">
            <h3>Lola</h3>
        ...
        <div class="animal-item">
            <img src="../img/dog4.jpeg" alt="Animal 5">
            <h3>Bob</h3>
            <p><strong>Espécie:</strong> Cão</p>
        ...
        <div class="animal-item">
            <img src="../img/dog.jpeg" alt="Animal 6">
            <h3>Rex</h3>
            <p><strong>Espécie:</strong> Cão</p>
