...
INSERT INTO `tb_agendoacao` VALUES (2,'2024-09-27','Sophia Cachorra','Ceara',1),(3,'2024-09-27','Ração para sophia, cachorra\r\n','rua cruz das almas',2);
...
INSERT INTO `tb_animais` VALUES (2,'JeyJey','Cachorra','Pincher 0','F','1953-04-24',NULL,NULL,NULL,NULL,'66f6b07faf657-jenifer.jpg'),(4,'Sophia','Cachorra','Vira lata','F','2022-02-22',NULL,NULL,NULL,NULL,'66f6acc31d857-imagem13.jpg'),(5,'Vivi','Cachorro','Afghan Hound','F','2007-12-27',NULL,NULL,NULL,NULL,'66f6b6e78ade8-afghan-hound-peludo.png'),(6,'Ikaro','cachorro','pé duro','M','2008-05-23',NULL,NULL,NULL,NULL,'66f6b7a6675d1-images.jpeg');
...
CREATE TABLE `tb_tutor_has_tb_animais` (
  ...
  CONSTRAINT `tb_tutor_has_tb_animais_ibfk_2` FOREIGN KEY (`id_tutor`) REFERENCES `tb_adocao` (`id_adocao`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_user` (
  ...
  `classe_user` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_user`)
...
INSERT INTO `tb_user` VALUES (1,'Ikaro','ikarogust32@gmail.com','$2y$10$yezJzARhBHlgP9a99uE1WerupvSbVeE2hWkuqzGqPI97KvFyCIo1y',NULL,NULL),(2,'jenifer','jenifer@gmail.com','$2y$10$Z.4ALczEUbIbBpvWZlCIv.yetReW1qyVCSZXP0jAt8.ZWxBWzNrI2',NULL,NULL);
...
-- Dump completed on 2024-09-27 11:23:37
